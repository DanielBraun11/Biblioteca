...
public class ServidorBiblioteca {
    public static void main(String args[]) {
        try {
            // Crear e inicializar el ORB (Object Request Broker)
    ...
    public static class GestionBibliotecaImpl extends GestionBibliotecaPOA {
        private ORB orb;
        ...
        public GestionBibliotecaImpl(ORB orb) {
            ...
            libros.put("1111", new Libro("1984", "George Orwell", "1111", true, 5));
            libros.put("2222", new Libro("Matar a un ruiseñor", "Harper Lee", "2222", true, 5));
            libros.put("3333", new Libro("Orgullo y prejuicio", "Jane Austen", "3333", true, 5));
            libros.put("4444", new Libro("El gran Gatsby", "F. Scott Fitzgerald", "4444", true, 5));
            libros.put("5555", new Libro("Crimen y castigo", "Fiódor Dostoyevski", "5555", true, 5));
        }
